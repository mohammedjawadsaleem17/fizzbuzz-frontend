...
export default function Form({handleSubmit,values,setValues}) {
  ...
  className="bg-indigo-50 border border-indigo-500 text-grey-600 font-sans text-sm rounded-lg focus:outline-indigo-500 block w-full p-2.5 dark:bg-indigo-700 dark:border-indigo-600 dark:placeholder-indigo-400 dark:text-white"
